...
export const projectsList: AddProjectData[] = [
  {
    ...
    skillTags: ['Vue 3', 'TypeScript', 'Pinia'],
    status: 'developing',
    progress: 85,
  ...
  },
  {
    ...
    skillTags: ['JavaScript', 'CSS3', 'Logic'],
    status: 'completed',
    progress: 95,
    githubUrl: 'https://github.com/',
    demoUrl: 'https://demo.com/',
  ...
  },
  {
    ...
    skillTags: ['Vue 3', 'Tailwind', 'Firebase'],
    status: 'developing',
    progress: 40,
    githubUrl: 'https://github.com/',
    demoUrl: 'https://demo.com/',
  ...
  {
    title: 'AI 寫程式助手整合 2',
    description: '提升前端開發效率，贊贊贊贊贊贊贊贊贊贊贊贊',
    imageUrl: '',
    skillTags: ['AI Tooling', 'Workflow'],
    status: 'completed',
    progress: 100,
